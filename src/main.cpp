...
uint256 hashGenesisBlock("0x0ccd9eaa5632a832fa708a0b976a2a2dccd0ddb052248e138a477fbb6d2d0a17");
...
static const int64 nTargetTimespan = 1 * 60 * 60; //
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x18f0e4340b81e6f160ef21b56dbfad8f0ffe1ee2be922f3f958216f51bde9525");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1390284168; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 95010;

        if (fTestNet)
        {
            block.nTime    = 1390282350;
            block.nNonce   = 1890939;
        }
